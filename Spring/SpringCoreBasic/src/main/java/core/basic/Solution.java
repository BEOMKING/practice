...
class Solution {
    ...
    public class File implements Comparable<File> {
		...
		public int compareTo(File o) {
			int start = findNumberStart(name);
			int number = findNumber(start, name);
			int oStart = findNumberStart(o.name);
			int oNumber = findNumber(oStart, o.name);

			int compareString = name.substring(0, start).toLowerCase().compareTo(o.name.substring(0, oStart).toLowerCase());
